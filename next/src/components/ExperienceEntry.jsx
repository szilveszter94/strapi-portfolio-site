  ...
  return (
    <li className="mb-14 ms-10">
      <span className="absolute flex items-center justify-center w-12 h-12 bg-neutral-50 rounded-full -start-6 ring-8 ring-white">
        {companyUrl ? (
          <a
            className="underline hover:no-underline hover:scale-105 transition"
      ...
      <BtnToggle
        ...
        openLabel={tButton("hideDescription")}
        closedLabel={tButton("showDescription")}
      />
