...
const sanitizerConfig = {
  ADD_TAGS: ["iframe"],
  ADD_ATTR: ["src", "style", "title", "allow", "sandbox", "width", "height", "frameborder", "allowfullscreen"],
};
...
export async function generateMetadata({ params }, parent) {
  ...
  try {
    data = await fetchDynamicPageMetadata("posts", slug, locale);
  } catch (error) {
  ...
  if (!data || !data.metadata) {
    return {
      ...
      description: "This page does not exist for the selected language.",
    };
  }
